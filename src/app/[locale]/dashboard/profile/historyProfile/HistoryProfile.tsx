...
import FormEditHistory from './formEditHistory/FormEditHistory';
import HistoryProfileController, {
...
const HistoryProfile = (props: HistoryControllerProps) => {
  const {
    historyUser,
    isEditHistory,
    isEdit,
    ...
    fromYear,
    toYear,
  } = HistoryProfileController(props);
  ...
  return (
    <>
      {editHistory && (
        <FormEditHistory
          open={editHistory}
          onChangeOpen={setEditHistory}
          data={historyUser}
          onChangeHistory={setHistoryUser}
        />
      )}
      {historyUser && (
        <div className="flex w-full">
          ...
          <div className="mb-4 ml-5 w-10/12 rounded-lg border border-gray-200 bg-white p-6 shadow-md">
            ...
            <h5 className="text-gray-600">{historyUser.company}</h5>
            <div style={{ whiteSpace: 'pre-line' }}>
              {historyUser.description}
            </div>
          </div>
        </div>
      )}
