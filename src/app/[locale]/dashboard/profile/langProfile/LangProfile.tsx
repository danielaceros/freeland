...
import FormEditLang from './formEditLang/FormEditLang';
  ...
  return (
    <>
      {editLang && (
        <FormEditLang
          open={editLang}
          onChangeOpen={setEditLang}
          data={langUser}
          onChangeHistory={setLangUser}
        />
      )}
      {langUser && (
        <div className="flex w-full">
          ...
          <div className="mb-4 ml-5 w-10/12 rounded-lg border border-gray-200 bg-white p-6 shadow-md">
            ...
            <h5 className="text-gray-600">{langUser.company}</h5>
            <div style={{ whiteSpace: 'pre-line' }}>{langUser.description}</div>
          </div>
        </div>
      )}
    </>
