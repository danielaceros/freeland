...
const FormNewHire = (props: FormNewHireProps) => {
  ...
  const categoryofferSkillsOptions = [
    ...
    },
    {
      ...
      subcategory: [
        {
          value: 'videoEditingSoftware',
          label: t('skills.videoEditingSoftware'),
        },
    ...
    },
    {
      ...
      subcategory: [
        ...
        { value: 'bigData', label: t('skills.bigData') },
        {
          ...
          label: t('skills.statisticalModeling'),
        },
      ],
    },
    {
    ...
    },
    {
      ...
      subcategory: [
        ...
        {
          value: 'cyberThreatIntelligence',
          label: t('skills.cyberThreatIntelligence'),
        },
    ...
    },
    {
      ...
      subcategory: [
        { value: 'serverManagement', label: t('skills.serverManagement') },
        {
          ...
          label: t('skills.networkAdministration'),
        },
        {
          value: 'cloudInfrastructure',
          label: t('skills.cloudInfrastructure'),
        },
  ...
  const handleSkillSelect = (selectedOptionsSkill: any) => {
    setSelectedSkills(
      selectedOptionsSkill
        ? selectedOptionsSkill.map((option: any) => option.value)
        : [],
    );
  };
