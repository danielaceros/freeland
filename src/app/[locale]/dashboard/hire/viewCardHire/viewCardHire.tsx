...
const ViewCardHire = (props: ViewCardHireProps) => {
  const { offer, showEdit, onOpenConfirmDeleteModal, onOpenModal } = props;
  ...
  return (
    ...
    >
      <div className="min-h-96 rounded-lg bg-white p-6 shadow-md transition-shadow  hover:shadow-xl ">
        <div className="">
          {showEdit && (
